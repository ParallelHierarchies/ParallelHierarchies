...
const VisiblePercentageBars = function() {
  let max = 100;
  let visible = 28;
  let dimensions = {
  ...
  const scaleX = d3.scaleBand().paddingInner(0.2);
  ...
  const generator = function(selection) {
    root = selection;
  ...
  let appendHundredPercentLine = function() {
    bars.selectAll('.hundred_percent').remove();
    bars.append('line')
...
export default VisiblePercentageBars;